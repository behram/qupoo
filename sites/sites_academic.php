...
require_once('db.php');
for($x=0;$x<3;$x++){
$sorgu=mysql_query("SELECT * FROM sites_academic WHERE site_order_academic='$x'",$db);
...
<a href="site-add.php?categori=10" target="_blank"><div class="q_qupoos out_qupoos" style="background-image:url(images/ekle2.png) !important;"><div class="yarim" style="width:180px;border-radius:200px;font-family:'opensans';font-weight:100;">Site Ekle</div></div></a>
