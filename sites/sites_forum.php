...
require_once('db.php');
for($x=0;$x<10;$x++){
$sorgu=mysql_query("SELECT * FROM sites_forum WHERE site_order_forum='$x'",$db);
...
<a href="site-add.php?categori=4" target="_blank"><div class="q_qupoos out_qupoos" style="background-image:url(images/ekle2.png) !important;"><div class="yarim" style="width:180px;border-radius:200px;font-family:'opensans';font-weight:100;">Site Ekle</div></div></a>
