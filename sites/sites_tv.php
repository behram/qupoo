...
require_once('db.php');
for($x=0;$x<6;$x++){
$sorgu=mysql_query("SELECT * FROM sites_tv WHERE site_order_tv='$x'",$db);
...
<a href="site-add.php?categori=13" target="_blank"><div class="q_qupoos out_qupoos" style="background-image:url(images/ekle2.png) !important;"><div class="yarim" style="width:180px;border-radius:200px;font-family:'opensans';font-weight:100;">Site Ekle</div></div></a>
