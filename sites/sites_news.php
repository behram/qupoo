...
require_once('db.php');
for($x=0;$x<12;$x++){
$sorgu=mysql_query("SELECT * FROM sites_news WHERE site_order_news='$x'",$db);
...
<a href="site-add.php?categori=7" target="_blank"><div class="q_qupoos out_qupoos" style="background-image:url(images/ekle2.png) !important;"><div class="yarim" style="width:180px;border-radius:200px;font-family:'opensans';font-weight:100;">Site Ekle</div></div></a>
