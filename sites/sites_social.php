...
require_once('db.php');
for($x=0;$x<45;$x++){
$sorgu=mysql_query("SELECT * FROM sites_social WHERE sites_social='$x'",$db);
...
<div class="info bilgi" id="'.$id2.'" title="site hakkında" style="background-image:url(small_icons/info_for_withlogin.png);"></div>
...
<div class="info add_id" style="left:25px;top:25px;background-image:url(small_icons/withlogin_plus.png);" id="'.$id.'"  title="qupoo\'s a ekle "></div>
</div>';
}}}
...
<a href="site-add.php?categori=2" target="_blank"><div class="q_qupoos out_qupoos" style="background-image:url(images/ekle2.png) !important;"><div class="yarim" style="width:180px;border-radius:200px;font-family:'opensans';font-weight:100;">Site Ekle</div></div></a>
