...
if($sonuc_h==1){ echo '<meta http-equiv="refresh" content="0;url=logged.php" />';}
...
<div style="width:70px;height:70px;margin-left:-35px;margin-bottom:-35px;bottom:50%;background:rgba(0,200,255,1);" class="kg_yuv"></div>
...
<span style="font-size:13px;margin-left:35px;text-align:right;">Şifremi unuttum</span>
