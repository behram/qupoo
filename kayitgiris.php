<?php ob_start(); ?>
<? require_once('db.php'); $uip=$_SERVER['REMOTE_ADDR'];mysql_query("INSERT INTO ips(uip) VALUES('$uip')")?>
...
<meta name="keywords" content="qupoo,qupoo.com,site bul,site keşfet,şifre sakla,üye ol,bilgi sakla,qupooKaşif,passtore,password,username,membership,üyelik,websiteler,anasayfa,eniyi siteler,siteler,qupoo passtore,hız,sosyal ağ,sosyal siteler" />
<meta name="description" content="qupoo kayıt giriş bölümünde giriş ve kayıt işlemlerinizi güvenle yapabilirsiniz." />
...
.kg_ena .form_ana{position:relative;width:450px;height:500px;border-radius:30px 0;margin-left:auto;margin-right:auto;margin-top:5%;background:rgba(255,255,255,0.1);}
.kg_ena .kayit_ol{position:absolute;top:15px;left:25px;width:200px;height:50px;background:rgb(0,200,255);border-radius:50px 0px;font-size:30px;text-align:center;line-height:50px;font-weight:500;font-family:Verdana, Geneva, sans-serif;color:rgba(255,255,255,1);cursor:pointer;-webkit-transition:all 0.15s ease-in;transition:all 0.15s ease-in;}
...
.kg_ena .kayit_form{position:absolute;top:60px;left:0px;background:rgba(0,255,0,0);width:100%;height:450px;border-radius:0px 0px 15px 15px;display:block;}
.kg_ena .giris_form{position:absolute;top:60px;left:0px;background:rgba(0,255,0,0);width:100%;height:450px;border-radius:0px 0px 15px 15px;display:none;}
.kg_ena input{width:80%;height:50px;border:rgba(255,255,255,1) 5px dashed;outline:none;font-size:25px;text-align:center;color:rgba(255,255,255,1);border-radius:100px;margin-left:10%;margin-right:10%;margin-top:5%;background:rgba(0,200,255,0.7)}
...
<form id="signin">
<input type="text" onblur="if(this.value.length == 0) this.value='E-mail';" onclick="if(this.value == 'E-mail') this.value='';" value="E-mail" name="email"/>
<input type="text" value="Şifre" style="position:absolute;top:84px;background:rgba(0,0,0,0)" id="gizle"/>
<input type="password"  id="goster" name="sifre"/>
<input type="text" value="Şifreyi Tekrar Girin"  style="position:absolute;top:168px;background:rgba(0,0,0,0)" id="gizle2"/>
...
<form id="login">
<input type="text" style="margin-top:15%;" onblur="if(this.value.length == 0) this.value='E-mail | Kullanıcıadı';" onclick="if(this.value == 'E-mail | Kullanıcıadı') this.value='';" value="E-mail | Kullanıcıadı" name="logmail"/>
<input type="text" value="Şifre"  style="position:absolute;top:173.5px;background:rgba(0,0,0,0)" id="gizle3"/>
