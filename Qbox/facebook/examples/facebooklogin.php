...
mysql_query("DELETE FROM `qupoo_db`.`qbox_facebook` WHERE `qbox_facebook`.`uid` = $uid");
...
echo "<script>window.location='http://qupoo.com/logged.php?from=facebook'</script>";


}else{

unset($_SESSION['fb_629051703785720_code']);
unset($_SESSION['fb_629051703785720_access_token']);
unset($_SESSION['fb_629051703785720_user_id']);
