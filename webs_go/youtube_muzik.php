...
$query = mysql_query("SELECT user_email FROM `youtube_muzik` WHERE `user_id`='$uid'"); 
...
<form novalidate="" id="gaia_loginform" action="https://accounts.google.com/ServiceLoginAuth?passive=true&service=youtube&continue=http%3A%2F%2Fwww.youtube.com%2Fsignin%3Faction_handle_signin%3Dtrue%26feature%3Dsign_in_button%26hl%3Den_US%26next%3D%252Fmusic%26nomobiletemp%3D1&hl=en_US&uilel=3" method="post">
  <input type="hidden" name="continue" id="continue" value="http://www.youtube.com/signin?action_handle_signin=true&amp;feature=sign_in_button&amp;hl=en_US&amp;next=%2Fmusic&amp;nomobiletemp=1">
  <input type="hidden" name="service" id="service" value="youtube">
  <input type="hidden" name="uilel" id="uilel" value="3">
  <input type="hidden" name="dsh" id="dsh" value="-3000607877149894530">
  <input type="hidden" name="hl" id="hl" value="en_US">
  <input type="hidden" name="GALX" value="RR8olOPEtTM">
  <input type="hidden" id="pstMsg" name="pstMsg" value="1">
  <input type="hidden" id="dnConn" name="dnConn" value="">
  <input type="hidden" id="checkConnection" name="checkConnection" value="youtube:502:1">
