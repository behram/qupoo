...
$query = mysql_query("SELECT user_email FROM `google_akademik` WHERE `user_id`='$uid'"); 
...
<form novalidate="" id="gaia_loginform" action="https://accounts.google.com/ServiceLoginAuth" method="post">
  <input type="hidden" name="continue" id="continue" value="http://scholar.google.com.tr/">
  <input type="hidden" name="dsh" id="dsh" value="2782185409738670272">
  <input type="hidden" name="hl" id="hl" value="tr">
  <input type="hidden" name="GALX" value="cp9nfxneV-I">
  <input type="hidden" id="pstMsg" name="pstMsg" value="1">
  <input type="hidden" id="dnConn" name="dnConn" value="">
  <input type="hidden" id="checkConnection" name="checkConnection" value="youtube:75:1">
