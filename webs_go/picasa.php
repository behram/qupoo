...
$query = mysql_query("SELECT user_email FROM `picasa` WHERE `user_id`='$uid'"); 
...
<form novalidate="" id="gaia_loginform" action="https://accounts.google.com/ServiceLoginAuth?hl=en_US&continue=https%3A%2F%2Fpicasaweb.google.com%2Flh%2Flogin%3Fcontinue%3Dhttps%253A%252F%252Fpicasaweb.google.com%252Fhome&service=lh2&ltmpl=gp&passive=true" method="post">
  <input type="hidden" name="continue" id="continue" value="https://picasaweb.google.com/lh/login?continue=https%3A%2F%2Fpicasaweb.google.com%2Fhome">
  <input type="hidden" name="service" id="service" value="lh2">
  <input type="hidden" name="dsh" id="dsh" value="-3716442133173460868">
  <input type="hidden" name="ltmpl" id="ltmpl" value="gp">
  ...
  <input type="hidden" id="checkConnection" name="checkConnection" value="youtube:95:1">
